...
Taken from Blinky's tests/simcam.py with only the import changed: here the
driver is digicarlo.blinky rather than a top-level blinky module."""
import array, io, os, sys
sys.path.insert(0, os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
import usb.core
from digicarlo import blinky                                   # noqa: E402
from digicarlo.blinky import Blink2, Log                       # noqa: E402
